...
class Tomita6(task.GeneralizationTask):
    ...
    def __init__(self):
          ...
          self.num_states = 3  # q0 through q3
          ...
          # q0 transitions
          transition_matrix = transition_matrix.at[0, 0].set(2)  # q0 --0--> q2
          transition_matrix = transition_matrix.at[0, 1].set(1)  # q0 --1--> q1
          
          # q1 transitions
          transition_matrix = transition_matrix.at[1, 0].set(0)  # q1 --0--> q0
          transition_matrix = transition_matrix.at[1, 1].set(2)  # q1 --1--> q2
          
          # q2 transitions
          transition_matrix = transition_matrix.at[2, 0].set(1)  # q2 --0--> q1
          transition_matrix = transition_matrix.at[2, 1].set(0)  # q2 --1--> q0
          
          # Define accepting states (q0, q1, q2 are accepting)
          accepting_states = jnp.array([True, False, False])
    ...
    def generate_positives(self, rng, batch_size, length):
        ...
        oversample_factor = 4  # Adjust based on expected rejection rate
    ...
    def generate_negatives(self, rng, batch_size, length):
        ...
        is_rejected = jnp.logical_or(final_states == 1, final_states == 2)
...
if __name__ == '__main__':
  ...
  for i in range(1, 41, 1):
    sample = tomita6.sample_batch(jax.random.PRNGKey(i), 16, i)
